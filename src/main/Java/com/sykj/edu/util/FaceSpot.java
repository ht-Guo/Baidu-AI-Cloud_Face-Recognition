...
public class FaceSpot {
    ...
    //需要修改为自己的
    private static final String AppID = "25707766";
    private static final String APIKey = "GNQjLPe6VGCiapXPQroE3EOU";
    private static final String SecretKey = "bnjPTTKLSoXYsy3XbSEpfoSGHu8YqBrd";
